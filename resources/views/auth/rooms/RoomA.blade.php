...
<head>
  ...
  <link rel="stylesheet" href="{{ secure_asset('/css/room.css') }}">
...
<body>
  ...
  <section>
    <div class="liveList">
        <iframe width="720" height="406" src="https://www.youtube.com/embed/" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <div class="liveTitle">
          <p>RoomA</p>
  ...
  <div class="sheet">
    <p>座席表</p>
    <img src="{{ secure_asset('/img/room_501.png')}}" alt="">
  </div>
</body>
<script>
